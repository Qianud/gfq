                            ...
                            <div class="widget-area">
                                ...
                                <div class="wizard-form-h">
                                    <div id="wizard" class="swMain">
                                        <ul>
                                            <li><a href="#step-1">Step<span class="stepDesc">1</span></a>
                                            </li>
                                            <li><a href="#ste
                                                p-2">Step<span class="stepDesc">2</span></a>
                                            </li>
                                            <li><a href="#step-3">Step<span class="stepDesc">3</span></a>
                                            </li>
                                        </ul>
                                        <div id="step-1">
                                            ...
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Your Email</label>
                                        ...
                                        <div id="step-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Company Name</label>
                                                    <input type="text" placeholder="Company Name" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Your Post</label>
                                                    <input type="text" placeholder="Your Post" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Company Email</label>
                                            ...
                                            <div class="col-md-12">
                                                <div class="inline-form">
                                                    <label class="c-label">Company Address</label>
                                        ...
                                        <div id="step-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Name on Card</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Expiration Date</label>
                                                    <select>
                                                        <option>1</option>
                                                        <option>2</option>
                                                        <option>3</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Expiration Year</label>
                                                    <select>
                                                        <option>2009</option>
                                                        <option>2010</option>
                                                        <option>2011</option>
                        ...
                        <div class="col-md-6">
                            <div class="widget-area">
                                <form role="form" class="sec">
                                    ...
                                    <button class="btn green btn-default" type="submit">Sign in</button>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="widget-area">
                                <form>
                                    ...
                                    <div class="radio pull-left">
                                        <label>
                                            <input type="radio" checked="" value="option1" id="optionsRadios1" name="optionsRadios"> Option one is this and that&mdash;be sure to include why it's great
                                        </label>
                                    </div>
                                    <div class="radio pull-left">
                                        <label>
                                            <input type="radio" value="option2" id="optionsRadios2" name="optionsRadios"> Option two can be something else and selecting it will deselect option one
                                        </label>
                                    </div>
                                    <div class="radio pull-left">
                                        <label>
                                            <input type="radio" value="option2" id="optionsRadios3" name="optionsRadios"> Option two can be something else and selecting it will deselect option one
                                        </label>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="widget-area">
                                <form>
                                    <fieldset disabled="">
                                        ...
                                        <button class="btn green btn-primary" type="submit">Submit</button>
                                    </fieldset>
                                </form>
                            </div>
                        </div>
